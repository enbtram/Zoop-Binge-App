...
import 'package:zoop_binge/i18n/i18n.dart';
import 'package:zoop_binge/src/elements/Loader.dart';
import 'package:zoop_binge/src/elements/WebViewElement.dart';
import 'package:zoop_binge/src/enum/connectivity_status.dart';
import 'package:zoop_binge/src/helpers/AdMobService.dart';
import 'package:zoop_binge/src/helpers/HexColor.dart';
import 'package:zoop_binge/src/models/setting.dart';
import 'package:zoop_binge/src/pages/OfflineScreen.dart';
import 'package:zoop_binge/src/position/PositionOptions.dart';
import 'package:zoop_binge/src/position/PositionResponse.dart';
          ...
          Expanded(
              child: InAppWebView(
                  ...
                  shouldOverrideUrlLoading:
                    ...
                    } else if (contains(widget.nativeApplication!, url) || contains(['redirect.zoopcoder.com/'], url) ) {
                      print(url);
